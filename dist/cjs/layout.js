...
exports.resolveAdvancedFreeze = resolveAdvancedFreeze;
exports.isPinnedAdvanced = isPinnedAdvanced;
exports.rightStartIndex = rightStartIndex;
exports.cellLayerAdvanced = cellLayerAdvanced;
exports.zIndexForLayerAdvanced = zIndexForLayerAdvanced;
exports.stickyOffsetRight = stickyOffsetRight;
exports.freezeCellStyleAdvanced = freezeCellStyleAdvanced;
const freeze_panes_table_1 = require("freeze-panes-table");
/**
...
function freezeCellStyleAdvanced(resolved, row, col, sizes) {
    ...
    if (layer === 'row' || layer === 'corner' || layer === 'corner-right' || layer === 'pinned') {
        style.top = (0, freeze_panes_table_1.stickyOffset)(sizes.rowHeights, row);
    }
    if (layer === 'col' || layer === 'corner' || layer === 'pinned') {
        style.left = (0, freeze_panes_table_1.stickyOffset)(sizes.colWidths, col);
    }
