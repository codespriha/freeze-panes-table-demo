import { freezeCellStyleAdvanced, resolveAdvancedFreeze, } from './layout.js';
import { injectAdvancedTableStyles } from './styles.js';
 ...
 */
export function createAdvancedTable(container, options) {
